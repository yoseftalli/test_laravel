...
<script>
      tinymce.init({
        ...
        language: 'ar'
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{url('/admin/update/'.$article->id)}}">
                    {{ csrf_field() }} {{--مهم جدا--}}
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="body" id="mytextarea">{{$article->body}}</textarea>
                    </div>
                    <div class="form-group">
                        <div class="row">
